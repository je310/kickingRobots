...
# macros for gcc
AS_DEFS =
C_DEFS = -D__weak="__attribute__((weak))" -D__packed="__attribute__((__packed__))" -DUSE_HAL_DRIVER -DSTM32F031x6 -D__weak="__attribute__((weak))" -D__packed="__attribute__((__packed__))" -DUSE_HAL_DRIVER -DSTM32F031x6
# includes for gcc
AS_INCLUDES =
...
#######################################
# link script
LDSCRIPT = STM32F031G6Ux_FLASH.ld
# libraries
LIBS = -lc -lm -lnosys 
LIBDIR =
